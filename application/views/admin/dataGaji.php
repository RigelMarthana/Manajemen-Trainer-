<div class="container-fluid">
    ...
    <div class="alert alert-info">
        Menampilkan Data Gaji Pegawai Bulan: <span class="font-weight-blod"><?php echo $bulan ?></span> Tahun: <span class="font-weight-blod"><?php echo $tahun ?></span>
    </div>
        ...
        ?>
            ...
            <?php }else{ ?>
                <span class="badge badge-danger">
                    ...
                    Data Absensi Masih Kosong, Silahkan Input Data Kehadiran pada Bulan Dan Tahun Yang Anda Pilih
                </span>
           <?php } ?>
        </div>
